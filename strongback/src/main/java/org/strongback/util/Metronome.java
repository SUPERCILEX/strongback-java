...
public interface Metronome {
     ...
     */
    static Metronome sleeper(long period, TimeUnit unit, Clock timeSystem) {
     ...
     * @return the new metronome; never null
     */
    static Metronome parker(long period, TimeUnit unit, Clock timeSystem) {
     ...
     * @return the new metronome; never null
     */
    static Metronome busy(long period, TimeUnit unit, Clock timeSystem) {
        long periodInNanos = unit.toNanos(period);
        return new Metronome() {
            private long next = timeSystem.currentTimeInNanos() + periodInNanos;
