...
public interface TalonController extends PIDController, TalonSRX {
    ...
    @Override
    TalonController enableLimitSwitch(boolean forward, boolean reverse);
     ...
     * @see #useProfile(int)
     */
    TalonController withGains(double p,
                              double i,
                              double d,
                              double feedForward,
                              int izone,
     ...
     * @see #useProfile(int)
     */
    TalonController withProfile(int profile,
                                double p,
                                double i,
                                double d,
                                double feedForward,
    ...
    @Override
    TalonController clearStickyFaults();

    @Override
    TalonController setSafetyEnabled(boolean enabled);
